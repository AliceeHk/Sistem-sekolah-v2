...
@section('content')
    <div class="mb-8 border-b border-[#E5E3DB] pb-5">
        ...
        <p class="mt-1 text-sm text-slate-500">Memperbarui catatan untuk jurusan <span class="font-medium text-[#16213A]">AKL</span>.</p>
    </div>
    ...
    <form action="" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8">
        ...
        <div>
            ...
            <textarea id="description" name="description" placeholder="Penjelasan singkat mengenai jurusan" class="w-full border border-[#D9D6CD] bg-[#FCFBF8] px-3.5 py-2.5 text-sm focus:border-[#A16207] focus:bg-white focus:outline-none">Program keahlian yang membekali murid dengan kompetensi pencatatan dan pelaporan keuangan.
            </textarea>
        </div>
